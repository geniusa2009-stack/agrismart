...
const arEg = {
  ...
  simpleMode: {
    switchToSimple: 'الوضع البسيط',
    switchToAdvanced: 'الوضع المتقدم',
    soilMoistureLabel: 'رطوبة الأرض',
    noReadingYet: 'لسه مفيش قراءة',
    lastUpdated: 'آخر تحديث {{time}}',
    deviceConnected: 'الحساس متصل',
    deviceOffline: 'الحساس مش متصل دلوقتي',
    deviceOfflineDetail: 'ممكن الرقم ده يكون قديم شوية.',
    verdict: {
      loading: 'بنشوف حالة أرضك…',
      collecting: 'لسه بنجمع قراءات كفاية عشان نطمّنك',
      collectingDetail: 'تعالى بعد شوية — AgriSmart محتاج سجل قراءات أكتر شوية الأول.',
      needsWater: 'أيوه، أرضك محتاجة ري',
      needsWaterDetail: 'رطوبة الأرض واطية. تقدر تبدأ الري دلوقتي.',
      monitor: 'أرضك تمام، بس تابعها',
      monitorDetail: 'مفيش داعي لأي إجراء دلوقتي.',
      fine: 'لأ، أرضك مش محتاجة ري',
      fineDetail: 'رطوبة الأرض كويسة.',
    },
    irrigateNow: 'روّي دلوقتي',
    askAgriSmart: 'اسأل AgriSmart',
    noFarmYet: 'اعمل مزرعتك الأول',
    noFarmYetDetail: 'كمّل خطوات الإعداد عشان تشوف أرضك هنا.',
  },
  common: {
    offline: 'مش متصل',
  },
