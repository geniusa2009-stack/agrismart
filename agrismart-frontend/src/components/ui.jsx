...
export function ErrorState({ title = 'Something went wrong', sub, onRetry, retryLabel = 'Retry' }) {
  return (
    <div className="py-8 text-center">
...
export function ConfirmDialog({ title, children, onCancel, onConfirm, confirmLabel, confirmTone = 'brand', busy, cancelLabel = 'Cancel' }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 px-4">
      <div className="w-full max-w-sm rounded-xl2 border border-slate-100 bg-white p-5 shadow-cardHover">
        <div className="flex items-center justify-between">
          ...
          <button onClick={onCancel} className="text-slate-400 hover:text-slate-600" aria-label={cancelLabel}>
            <XIcon />
          </button>
        </div>
